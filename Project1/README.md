...
# 배열(Array)이란?
+ 배열은 같은 종류의 데이터를 여러 개 모아놓은 **“상자 묶음”**이라고 볼 수 있습니다.
+ 예를 들어, 8개의 정수를 저장하고 싶다면, 크기가 8개짜리 정수 배열을 만들 수 있습니다.
+ 배열을 만들 때는 배열이름[개수] 형태로 선언합니다.
...
+ 정리
배열은 같은 자료형 데이터를 연속해서 보관하는 **“상자 묶음”**입니다.
