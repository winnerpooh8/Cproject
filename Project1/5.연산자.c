...
//연산을 진행 할때 필요한 식이나 값을 항이라고 부르겠습니다.
...
int main()
{
	...
	//작성위치에 따라 판정이 다르게 처리됩니다.
	//a++일 경우를 후위형 증감 연산이라고 부르며, 이 경우에는 연산을 먼저 진행한 뒤, a의 값을 1증가시킵니다.
	//따라서 대입 연산에 의해 b는 a(10)의 값을 대입하게 되고, 그 후에 a가 1 증가합니다.
    
	//b = ++a일 경우를 전위형 증감 연산이라고 부르며, 이 경우에는 a 대한 1증가를 먼저 진행하고, 연산을 처리합니다.
	//a가 1증가해서 12가 되고,그 후 b에 대입하게 됩니다. b=12


	//관계연산자
	//연산자를 기준으로 왼쪽과 오른쪽의 값의 크기를 비교해서 참 또는 거짓을 확인합니다.
	//참일경우 1을 거짓일 경우 0으로 처리됩니다.
