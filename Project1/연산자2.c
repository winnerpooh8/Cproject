...
int main()
{
	...
	c = a ^ b; //a XOR b
	printf("a^b= %d\n", c);
	//XOR(EXCLUSIVE OR) : 배타적 논리합, 대팅차집합
	//a와 b를 비교했을 때 비트가 다른 지점을 1, 같으면 0으로 처리합니다.
	//이 연산방식은 암호학의 기초로 많이 활용됩니다.
	//1011
	//1110
	//0101  ->  4 + 1 -> 5
	...
	printf("c = %d/n", c);
	//shift 연산
	//a >>4일 경우 a를 비트 4칸 이동합니다. 비트4칸은 2의 제곱 (16)을 의미합니다.
	//a / 16과 동일한 결과
	...
	//11 & 14는 11과 14가 가지고 있는 비트 중에서 겹치는 부분만 1처리, 나머지는 다0으로 
	//1011
	//1110
	//1010 => 8 + 2 => 10
